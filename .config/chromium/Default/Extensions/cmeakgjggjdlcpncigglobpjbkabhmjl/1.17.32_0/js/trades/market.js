const marketService = function (ws_url, debug) {
    ...
    const WS = function (address) {
        ...
        this.emit = function (event, data, clb) {
            ...
            poolEventsSub[event].forEach((e,i) => {try {e(data, clb)} catch (e) {logger.log(e)}});
        };
        ...
        requestGet(communityURL, function (data, err) {
            ...
            let hookerHeaders = (details) => {
                ...
                for (let n in details.requestHeaders) {
                    ...
                    if (gotRef) { details.requestHeaders[n].value = "https://steamcommunity.com/tradeoffer/new/";}
                }
                if (!gotRef) {details.requestHeaders.push({name: "Referer", value: "https://steamcommunity.com/tradeoffer/new/"});}
    ...
    HANDLERS['getSteamId'] = function(req, sendResponse) {
        ...
        requestGet("https://steamcommunity.com/", function(data, err) {
            if (err) {
...
const MRService = new marketService('wss://appws.dota2.net/', false);
// Start service
MRService.start();
