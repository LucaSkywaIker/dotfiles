...
$(document).ready(function () {
  setTimeout(function () {
    ...
    // );
    $('.sponsor a').prop('href', 'https://cs.money/?utm_source=sponsorship&utm_medium=sih&utm_campaign=sih1019&utm_content=bannerbig');
    $('.sponsor-link a').prop('href', 'https://cs.money/?utm_source=sponsorship&utm_medium=sih&utm_campaign=sih1019&utm_content=bannerbig');
    var sponsorImg = $('.sponsor img');
    chrome.runtime.sendMessage(chrome.runtime.id, { type: 'GetBanner', data: { size: 'big', partner: 'csmoney' } }, (res) => {
      if (res.success) {
